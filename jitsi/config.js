...
config.constraints.video.height = { ideal: 1080, max: 1080, min: 1080 };
config.constraints.video.width = { ideal: 1920, max: 1920, min: 1920};
config.disableSimulcast = true;
config.startWithVideoMuted = true;

// ScreenShare Configuration.
//
config.desktopSharingFrameRate = { min: 1, max: 60 };
